...
class Ui_Index(object):
    def setupUi(self, Index):
        ...
        Index.setTabOrder(self.Button_reset, self.ListBox_d_2)
        Index.setTabOrder(self.ListBox_d_2, self.distance_button)
        Index.setTabOrder(self.distance_button, self.tilt_a_entry)
        Index.setTabOrder(self.tilt_a_entry, self.alpha_signBox)
        Index.setTabOrder(self.alpha_signBox, self.diff_spot_Listbox)
        Index.setTabOrder(self.diff_spot_Listbox, self.add_spot_button)
        Index.setTabOrder(self.add_spot_button, self.euler_listbox)
    ...
    def retranslateUi(self, Index):
        ...
        self.label_4.setText(_translate("Index", "<html><head/><body><p><span style=\" font-weight:600;\">Data</span></p></body></html>", None))
        self.alpha_label_2.setText(_translate("Index", "α (°)", None))
        self.label_2.setText(_translate("Index", "<html><head/><body><p><span style=\" font-weight:600;\">g vectors</span></p></body></html>", None))
        ...
        self.label_3.setText(_translate("Index", "<html><head/><body><p><span style=\" font-weight:600;\">Tilt angles/AC</span></p></body></html>", None))
        self.Button_reset_all.setText(_translate("Index", "Reset all", None))
        self.tilt_axis_angle_label.setText(_translate("Index", "Diffraction-α tilt angle", None))
        ...
        self.beta_label.setText(_translate("Index", "β (°)", None))
        self.add_spot_button.setText(_translate("Index", "Add data", None))
        self.n_label.setText(_translate("Index", "Number of spots", None))
        self.z_label.setText(_translate("Index", "z (°)", None))
